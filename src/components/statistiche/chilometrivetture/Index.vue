<template>
    <ion-page>
                ...
                <ion-item>
                    <ion-grid>
                        <ion-row class="ion-justify-content-between ion-align-items-center">
                            <div>
                                <ion-title>Chilometri Vetture</ion-title>
                            </div>
                            <div>
        ...
        <ion-item color="success" v-if="totale">
            <ion-grid>
                <ion-row>
                    <ion-col size="4">Giorno</ion-col>
                    <ion-col size="3">Dettagli</ion-col>
                </ion-row>
            </ion-grid>
        </ion-item>
        ...
        <ion-content>
            ...
            <ion-item color="warning" v-if="totale">
                <ion-grid>
                    <ion-row>
                        <ion-col size="12">Km Totali: {{totale}}</ion-col>
                    </ion-row>
                </ion-grid>
            </ion-item>
            <ion-item/>
...
<script>
    ...
    export default {
        ...
        methods:{
            caricaRisultati(){
                eventBus().emitter.on("caricastatistichechilometrivetture", (dati) => {
